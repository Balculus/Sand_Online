...
![S3VM 图解](https://raw.githubusercontent.com/Balculus/Sand/master/_posts/image/2022-10-14-TSVM/1665711723825.png "S3VM 图解")

半监督中最著名的是TSVM （Transductive Support Vector Machine）。这里需要说明一下，S3VM 和 TSVM 有相同的地方，也有不同的地方。

首先 TSVM 来源于 1999年的文章[1]，阅读原始的文献可以看出与周志华《机器学习》里面的半监督 SVM 介绍是相同的。
