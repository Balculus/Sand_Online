...
![1665711723825](image/2022-10-14-TSVM/1665711723825.png)



 I盯在考虑未标记样本后， S3VM 试图找到能将两类有标记样本分卅7 且穿过数据低密度区域的划分超平面， 如图13 . 3 所示，这里的基本假设足"低密皮分阳" (low-density separatio且) ， 显然，这是聚类假设在考虑了线性超平面划分后的批(".
